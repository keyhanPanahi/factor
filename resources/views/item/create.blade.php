        ...
        <div class="row">
            ...
            <div class="col-12 mb-30">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="{{ route('item.store',$factor->id) }}" method="post">
                            @csrf
                        <div class="row mbn-20">
                            ...
                            <div class="col-lg-4 col-12 mb-20">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="unit_price" class="form-control form-control-sm" value="{{ old('unit_price') }}">
                                </div>
                                @error('unit_price')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
                            ...
                            <div class="col-lg-4 col-12 mb-20">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="amount" class="form-control form-control-sm" value="{{ old('amount') }}">
                                </div>
                                @error('amount')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
