        ...
        <div class="row justify-content-between align-items-center mb-10">
            ...
            <div class="col-12 col-lg-auto mb-20">
                <div class="page-heading">
                    <h3 class="title">ویرایش فاکتور</h3>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-12 mb-30">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="{{ route('factor.update',$factor->id) }}" method="post">
                            @csrf
                            @method('put')
                        <div class="row mbn-20">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="customer_id" id="" class="form-control form-control-sm">
                                        ...
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->id }}" @if(old('customer_id',$factor->customer_id) == $customer->id) selected @endif>{{ $customer->name }}</option>
                                        @endforeach
                            ...
                            <div class="col-lg-4 col-12 mb-20">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subject" class="form-control form-control-sm" value="{{ old('subject',$factor->subject) }}">
                                </div>
                                @error('subject')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
                            ...
                            <div class="col-lg-4 col-12 mb-20">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="date_view" class="form-control form-control-sm" value="{{ old('date',$factor->date) }}">
                                </div>
                                @error('date')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
